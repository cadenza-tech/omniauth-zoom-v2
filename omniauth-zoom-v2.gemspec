...
require_relative 'lib/omniauth/zoom_v2/version'

Gem::Specification.new do |spec|
  spec.name = 'omniauth-zoom-v2'
  spec.version = OmniAuth::ZoomV2::VERSION
  spec.description = 'Zoom strategy for OmniAuth'
  spec.summary = 'Zoom strategy for OmniAuth'
  spec.authors = ['Masahiro']
  spec.email = ['watanabe@cadenza-tech.com']
  spec.license = 'MIT'

  github_root_uri = 'https://github.com/cadenza-tech/omniauth-zoom-v2'
